...
<button data-drawer-target="separator-sidebar" data-drawer-toggle="separator-sidebar" aria-controls="separator-sidebar"
    type="button"
    class="fixed z-30 inline-flex items-center my-6 p-2 text-sm text-white rounded-lg sm:hidden focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
...
<aside id="separator-sidebar"
    class="block fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
    aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-green-custom-200 dark:bg-gray-800">
        <a href="#" class="flex items-center pl-2.5 mb-2">
            <img src="{{ asset('images/kairapp-isologo-negro-300px.svg') }}" class="h-7 mr-3 sm:h-7"
                alt="Kairapp Logo" />
        ...
        <ul class="space-y-2 font-medium">
            ...
            @if (session('role')->id === 2)
                <label for="subStores" class="hidden">
                    Sucursal seleccionada</label>
                <select id="subStores" class="hidden">
                ...
                <li>
                    <a href="{{ route('orders-store-management.index') }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-custom-600 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 18 20">
                            <path
                ...
                <li>
                    <a href="{{ route('inventory.index') }}"
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Gestor de inventario</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('collaborators.index') }}"
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Administrar trabajadores</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('schedule-stores.index') }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Horarios Tienda</span>
                    </a>
                </li>
                {{-- <li>
                    <a href="#"
            ...
            @elseif (session('role')->id === 1)
                ...
                <li>
                    <a href="{{ route('stores-management.index') }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 20 20">
            ...
            @if (session('role')->id === 2)
                <li>
                    <a href="{{ route('profile-store.index') }}"
                        ...
                        <span class="ml-3">Perfil Tienda</span>
                    </a>
                </li>
            @endif
            <li>
